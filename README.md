# Kitsune DX with Nvidia drivers

This repository is a customized version of Bazzite DX (Nvidia), tweaked for my preferences.
...
#### Using the Github Web Interface (preferred)
...
Note: brackets indicate alternate versions.

- Bazzite: `ghcr.io/ublue-os/bazzite[-nvidia][-gnome]:stable`
- Bazzite DX: `ghcr.io/ublue-os/bazzite-dx[-nvidia][-gnome]:stable`
